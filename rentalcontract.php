...
$sql2="SELECT StartDate,EndDate,CustomerLogin 
	   FROM reservation
	   WHERE ReservationNumber='$reservationnumber'"; 
//echo "$sql2";
                ...
                <body>
				  ...
				  <table  align="center"  bgcolor="#FFFFFF"  border="0"  cellpadding="5"
                      ...
                      <tbody>
						...
						<tr><td style="text-align: center;"  width="600"><h2>HANDYMAN TOOLS RENTAL CONTRACT </h2></td>
						</tr>
					</tbody>
				</table>
				  
                  <form  name="Form"  method="get"  action="checkrentalcontract.php"  onsubmit="return validateForm()">
                    <table  align="center"  bgcolor="#FFFFFF"  border="0"  cellpadding="5"
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td>
                                Pick Up Date: <?php echo date("Y-m-d"); ?>
                            </td>
                        </tr>
						...
						<tr>
							<td>Estimated Rental: $<?php echo "$totalcost"; ?>
							</td>
						</tr>
						
						<tr><td>Signature:________________________________________</td></tr>
