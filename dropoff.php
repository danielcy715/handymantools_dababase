...
$customerid=$row2['CustomerLogin'];
 ...
 type="submit" onclick="window.location.href=''" >
						...
						<form  name="Form"  method="get"  action="receipt.php"  onsubmit="return validateForm()">
                    <table  align="center"  bgcolor="#FFFFFF"  border="0"  cellpadding="5"
					   ...
					   <tbody>
                        ...
                        <tr>
                          <td  style="text-align: left;"  width="300"><input  name="completedropoff"

 value="Complete Drop Off and View Summary"  onclick="window.location.href=''"  type="submit"><input  name="cancel"  
