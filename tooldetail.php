      ...
      <form  name="Form"  method="POST"  action=""  onsubmit="return validateForm()">
         <table  align="center"  bgcolor="#FFFFFF"  border="0"  cellpadding="5"
            ...
            <tbody>
			   ...
			   <tr><td><hr></td></tr>
               <tr>
                  <td style="text-align: left;"> If item is a Power Tool, then include accessories below. 
                     
                  </td>
               </tr>
               
			   <?php
					$sql="SELECT * FROM powertoolaccessories WHERE ToolID='$id'"; 
					//echo "$sql";
					$result=mysql_query($sql);
