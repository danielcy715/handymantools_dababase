...
<html>
   ...
   <body>
      ...
      <form  name="Form"  action="checkregistration.php" method="POST" onsubmit="return validateForm()" >
         <table  style="width: 500px; height: 440px;"  align="center"
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td><input  name="confirmpassword"  type="text" required></td>
               </tr>
               <tr>
                  <td>First Name</td>
               ...
               <tr>
                  ...
                  <td><input  name="homephoneareacode" maxlength="3" type="text"></td>
               </tr>
               <tr>
                  <td>Home Phone Local Code</td>
                  <td><input  name="homephonelocalcode" maxlength="7" type="text"></td>
               </tr>
               <tr>
                  <td>Work Phone Area Code</td>
                  <td><input  name="workphoneareacode" maxlength="3" type="text"></td>
               </tr>
               <tr>
                  <td>Work Phone Local Code</td>
                  <td><input  name="workphonelocalcode" maxlength="7" type="text"></td>
               </tr>
               <tr>
                   <td>Address</td>
